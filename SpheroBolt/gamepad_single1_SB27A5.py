...
def main():
    ...
    sphero_controller = SpheroController(joystick, sphero_color, 1)

    # Prompt the user to enter the toy name
    #toy_name = input("Enter the toy name you want to connect to: ")

    sphero_controller.discover_toy("SB-27A5")
