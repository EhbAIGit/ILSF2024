        ...
        try:
            with self.connect_toy() as api:
                ...
                while self.is_running:
                    ...
                    #Buttons = [self.joystick.get_button(0),self.joystick.get_button(1),self.joystick.get_button(2),self.joystick.get_button(3),self.joystick.get_button(4),self.joystick.get_button(5),self.joystick.get_button(6),self.joystick.get_button(7),self.joystick.get_button(8),self.joystick.get_button(9),self.joystick.get_button(10)]
                    #print("X-as: {:.2f}, Y-as: {:.2f}, Button3:{}".format(X, Y,Buttons))
