...
toy = scanner.find_toy(toy_name='SB-62C3')
with SpheroEduAPI(toy) as droid:
    ...
    def on_press(key):
        try:
            ...
            if key.char == 't':  # Vooruit bewegen
                droid.roll(0, 60, 0.2)
            elif key.char == 'v':  # Achteruit bewegen
                droid.roll(180, 60, 0.2)
            elif key.char == 'f':  # Naar links bewegen
                droid.roll(270, 60, 0.2)
            elif key.char == 'g':  # Naar rechts bewegen
